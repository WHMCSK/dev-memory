...
| 评估人 | 选择 |
| --- | --- |
| p1 | 英语报站-5.wav、中文报站-4.wav、英语报站-3.wav、中文报站-9.wav |
| p2 | 中文4和中文10、英文选  2、3 |
| p3 |  |
...
1. 试验目的：
    ...
    * 采用vits模型微调训练得到“久事公交旧报站女”的语音合成模型，并测试其在报站场景下的语音合成效果。
    * 充分认识采用微调模型能达到的效果，结束微调模型技术试验，进入待产阶段。

2. 试验方法：

    * 模型微调
    * 推理时调参，抽卡。
    * 每个语种随机选择3个报站文本，每条文本抽卡2个差异比较明显的语音。
    * E4-94FA01-ZH-1-1，E4：第四次试验，FA01：说话人代号，ZH：普通话，1：第1个文本，1：第1条语音。每个参与者给每个文本选择一条适合上线的语音。
    * 采取双盲测试，原版录音为对照样本，合成语音为试验样本，对照样本和试验样本均发送给测试者和参与者。

3. 训练数据准备：

| 说话人 | 语种 | 数据来源 | 数据处理方式 |
| --- | --- | --- | --- |
| 久事公交旧报站女 | 普通话 | 久事公交旧女声原版录音文件 | 手动剪辑+程序自动化切分+批量ASR标注+人工校对标注 |
| 久事公交旧报站女 | 英语 | 久事公交旧女声原版录音文件 | 手动剪辑+程序自动化切分+批量ASR标注+人工校对标注 |

4. 评估表格

| 语音编号 | 文本内容 | 是否愿意在项目中使用 | 是否组内最优 | 备注 |
| --- | --- | --- | --- | --- |
...
| 语音编号 | 说话人 | 语种 |
| --- | --- | --- |
| ZH-1-1 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-1-2 | 久事公交旧报站女（94FA01） | 原版录音 |
| ZH-1-3 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-2-1 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-2-2 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-2-3 | 久事公交旧报站女（94FA01） | 原版录音 |
| ZH-3-1 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-3-2 | 久事公交旧报站女（94FA01） | 普通话 |
| ZH-3-3 | 久事公交旧报站女（94FA01） | 原版录音 |
| EN-1-1 | 久事公交旧报站女（94FA01） | 英语 |
| EN-1-2 | 久事公交旧报站女（94FA01） | 英语 |
| EN-1-3 | 久事公交旧报站女（94FA01） | 原版录音 |
| EN-2-1 | 久事公交旧报站女（94FA01） | 英语 |
| EN-2-2 | 久事公交旧报站女（94FA01） | 英语 |
| EN-2-3 | 久事公交旧报站女（94FA01） | 原版录音 |
| EN-3-1 | 久事公交旧报站女（94FA01） | 原版录音 |
| EN-3-2 | 久事公交旧报站女（94FA01） | 英语 |
| EN-3-3 | 久事公交旧报站女（94FA01） | 英语 |
